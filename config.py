...
# ── Models ─────────────────────────────────────────────────────────────────────
DEFAULT_MODEL = "gemini-3.1-pro"                # LLM for reasoning
...
RETRIEVAL_MIN_SCORE = 0.35   # discard retrieved pages below this similarity; 0.0 = no filter
JUDGE_MODEL = "cborg-mini-fast"      # free model used for LLM-graded answer equivalence
